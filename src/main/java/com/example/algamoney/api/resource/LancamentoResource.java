...
public class LancamentoResource {
	...
	public ResponseEntity<byte[]> relatorioPorPessoa(
			...
			@RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate dataRelatorio) throws Exception {
		
		byte[] relatorio = lancamentoService.relatorioPorPessoa(inicio, fim, dataRelatorio);
	...
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_LANCAMENTO') and #oauth2.hasScope('read')")
	public List<LancamentoEstatisticaCategoria> porCategoria(@RequestParam("tipoLancamento") TipoLancamento tipoLancamento) {
